	...
	<div id="main">
		...
		<div id="panel">
			<?php
				...
				$sql = "SELECT nazwa_lotu, koszt, data, czas_min, ilosc_km, start, cel, img, typ FROM loty WHERE typ = 'VIP_oczekuje'
							OR typ = 'Standardowy_oczekuje' OR typ = 'Promocja_oczekuje'";
				foreach ($dbh->query($sql) as $row) {
					...
					echo "<table class='table_shows'>
							<tr>
								...
								<td rowspan='8'>
									<form method='POST' action='/linie_lot/pages/airways.php'>
										<input class='button_table2' type='submit'  value='Akceptuj' name='$nazwa_accept'/><br><br>
										<input class='button_table3' type='submit' value='Odrzuć' name='$nazwa'/>
									</form>
								</td>
							</tr>
							<tr>
